...
::: callout-important
## NOTE: In lieu of a paper
You will do a Presentation, Calculations, and an Abstract. 

-  Working with your partner, complete the modeling below.
-  Give your final PRESENTATION at the last class,
-  Submit your CALCULATIONS and an ABSTRACT by Dec 17th. 
    -  Calculations must be written out neatly, (similar in size to 11pt font), with a few words of justification for each choice (equations, assumptions, etc.), and citation. 
    - Post in the Design 4 folder on the shared Google Drive. 
:::
