...
-  Bullet-point the most relevant background in this experiment, and how it might connect to a hypothesis.  
    ...
    +  Start from what we know about the topic, and connect to what we are trying to demonstrate or find out in the current experiment. Be sure to introduce any ideas that go into your hypothesis. In other words.  
-  A starting hypothesis (or hypotheses if there are multiple parts). 
-  (Later, as you think about writing an introduction for your lab report, try to foreshadow why the current experiment is important.)
