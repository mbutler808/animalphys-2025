...
:::{.callout-note}
# Prepare for lab by:
- Tuesday Lab will perform this experiment on 11/25/25 due to the Veterans Day Holiday
- Wednesday Lab will perform this experiment on 11/19/25
...
![The human cerebrum, annotated with functional regions (lobes). Vectorized by [Jkwchui](http://training.seer.cancer.gov/module_anatomy/unit5_3_nerve_org1_cns.html), CC BY-SA 3.0, [original](https://commons.wikimedia.org/w/index.php?curid=29055751)](../../images/lab11-cerebrum-lobes.png){#fig-brain}
