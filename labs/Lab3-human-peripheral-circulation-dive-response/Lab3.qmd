...
:::{.callout-note}
# Prepare for lab by:
- We will do the _Practical based on Lab 1 material_.  Let us know if you want tor come in to practice ahead of time. 
...
### Questions for thought...
1.  How much does blood pressure change for each treatment? What could explain it? Does it seem reasonable?
...
1. Attach the  pulse transducer to Input 1, and the respiratory belt transducer to Input 2.
2. Use “Lab 3-Dive Response...” settings to start Chart software.
3. Add 1 channel Blood Volume. 
  -  From the menu bar, choose __Setup > Channel Settings__.  At the bottom of the menu, increase the number of channels by 1.  
  ...
  -  Name channel 2 "Blood Volume".  On the right side bar, click on "Blood Volume" and select teh Arithmetic panel. Under the formula box select the channel that is reading the respiratory belt transducer. Multiply that signal by 100. The Forumla box should read something like "(Ch2\*100)". 
...
5.  Attach the respiratory belt to the calf (@fig-calf) to measure leg volume. _NOTE: These are very fragile and expensive! Easily broken if stretched too tightly -- tighten just enough to stay up._ 
...
- Write a Group Lab Report following \[[Peripheral Circulation Report Guidance](Lab3_report.pdf)\]
